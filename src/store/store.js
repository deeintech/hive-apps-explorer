  ...
  state: {
    ...
    dapps: [
      ...
      { 
        ...
        value: 'tribes',
        customJson: [],
        accounts: ['palnet', 'palnetapp', 'sports', 'steemsports', 'zzan', 'neoxian'],
        metadataTags: ['palnet', 'aaa', 'steemzzang', 'neoxag', 'sct', 'stem', 'weedcash', 'sports', 'leo', 'jahm'],
        metadataAppNames: ['palnet', 'aaa', 'zzan', 'weedcash', 'steemleo'],
        scotTokens: ['PAL', 'NEOXAG', 'CCC', 'LEO', 'GG', 'SCT', 'STEM', 'NATRL', 'SONIC', 'AAA', 'ACTNEARN',
        'ASS', 'ATTDUMMY', 'BATTLE', 'BLQ', 'BPC', 'CTP', 'DOLPHIN', 'ENG', 'INT', 'IV', 'JAHM', 'LIFESTYLE', 'LIV',
        'MARLIANS', 'MOT', 'NGA', 'RHB', 'SPACO', 'SPORTS', 'TMT', 'TUNES', 'UFM', 'WEED', 'ZZAN', 'BEER'],
