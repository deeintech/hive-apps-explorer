    ...
    <section>
        <div class="container aos-init aos-animate" data-aos="fade-up">
            ...
            <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
                <img src="../assets/img/logo.jpg" alt="logo" class="rounded shadow-3d"/>
            </div>
      ...
      <div class="row">
        <div class="col">
          <div class="h1">Interested in collaborating?</div>
            <div class="my-5">
              <a href="https://twitter.com/dmitrydao" class="btn btn-lg btn-primary" target="_blank">Get In Touch</a>
            </div>
          </div>
        </div>
        <div class="row">
